...
tblastx -query $tr1 -db $tr2 -outfmt 6 -out "${n1}_to_${n2}.txt" -num_threads ${n_threads} -max_hsps 1 -evalue 1e-6
#tblastx -query $tr2 -db $tr1 -outfmt 6 -out "${n2}_to_${n1}.txt" -num_threads ${n_threads} -max_hsps 1 -evalue 1e-6
fi

if [[ "$t1" == "nucl" && "$t2" == "prot" ]]
then
echo "Running blastx from 1 to 2"
blastx -query $tr1 -db $tr2 -outfmt 6 -out "${n1}_to_${n2}.txt" -num_threads ${n_threads} -max_hsps 1 -evalue 1e-6
#tblastn -query $tr2 -db $tr1 -outfmt 6 -out "${n2}_to_${n1}.txt" -num_threads ${n_threads} -max_hsps 1 -evalue 1e-6
fi

if [[ "$t1" == "prot" && "$t2" == "nucl" ]]
then
echo "Running tblastn from 1 to 2"
tblastn -query $tr1 -db $tr2 -outfmt 6 -out "${n1}_to_${n2}.txt" -num_threads ${n_threads} -max_hsps 1 -evalue 1e-6
#blastx -query $tr2 -db $tr1 -outfmt 6 -out "${n2}_to_${n1}.txt" -num_threads ${n_threads} -max_hsps 1 -evalue 1e-6
fi

if [[ "$t1" == "prot" && "$t2" == "prot" ]]
then
echo "Running blastp"
blastp -query $tr1 -db $tr2 -outfmt 6 -out "${n1}_to_${n2}.txt" -num_threads ${n_threads} -max_hsps 1 -evalue 1e-6
#blastp -query $tr2 -db $tr1 -outfmt 6 -out "${n2}_to_${n1}.txt" -num_threads ${n_threads} -max_hsps 1 -evalue 1e-6
fi
